                            ...
                            <ul className='nav-bar-list'>
                                <li className='nav-bar-item'>
                                    <NavLink to='/' exact={true} className='nav-link'
                                             activeClassName='active'>Gear</NavLink>
                                </li>
                                <li className='nav-bar-item'>
                                ...
                                <li className='nav-bar-item'>
                                    <NavLink to='/ngus' exact={true} className='nav-link'
                                             activeClassName='active'>NGUs</NavLink>
                                </li>
                                <li className='nav-bar-item'>
                                    <NavLink to='/hacks' exact={true} className='nav-link'
                                             activeClassName='active'>Hacks</NavLink>
                                </li>
                                <li className='nav-bar-item'>
                                ...
                                <li className='nav-bar-item'>
                                    <NavLink to='/howto' exact={true} className='nav-link' activeClassName='active'>How
                                        to</NavLink>
                                </li>

...
const BinaryLibraryRecord = require('./BinaryLibraryRecord');
const ClassWithIdRecord = require('./ClassWithIdRecord');
const SystemClassWithMembersRecord = require('./SystemClassWithMembersRecord');
const ClassWithMembersRecord = require('./ClassWithMembersRecord');
const SystemClassWithMembersAndTypesRecord = require('./SystemClassWithMembersAndTypesRecord');
const ClassWithMembersAndTypesRecord = require('./ClassWithMembersAndTypesRecord');
const BinaryObjectStringRecord = require('./BinaryObjectStringRecord');
const BinaryArrayRecord = require('./BinaryArrayRecord');
const MemberPrimitiveTypedRecord = require('./MemberPrimitiveTypedRecord');
const MemberReferenceRecord = require('./MemberReferenceRecord');
const ObjectNullMultipleRecord = require('./ObjectNullMultipleRecord');
const ArraySinglePrimitiveRecord = require('./ArraySinglePrimitiveRecord');
const ArraySingleObjectRecord = require('./ArraySingleObjectRecord');
const ArraySingleStringRecord = require('./ArraySingleStringRecord');
const PrimitiveReader = require('./PrimitiveReader');
const DeferredReference = require('./DeferredReference');
const DeferredItem = require('./DeferredItem');
const RecordType = require('./RecordType');
const SerializationHeaderRecord = require('./SerializationHeaderRecord');

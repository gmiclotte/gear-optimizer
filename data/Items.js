...
export const ITEMLIST = [
    ...
    new Item('Edgy Helmet', Slot.HEAD, SetName.EDGY, 100, [
        ...
        [Stat.MAGIC_CAP, 660],
        [Stat.MAGIC_BARS, 5200],
        [Stat.ENERGY_POWER, 7200],
        [Stat.MAGIC_POWER, 7200],
    ]),
    ...
    new Item('BOTH Edgy Boots', Slot.BOOTS, SetName.EDGY, 100, [
        ...
        [Stat.ENERGY_CAP, 840],
        [Stat.MAGIC_CAP, 840],
        [Stat.ENERGY_BARS, 8400],
        [Stat.MAGIC_BARS, 8400],
        [Stat.ENERGY_POWER, 8400],
        [Stat.MAGIC_POWER, 8400],
    ]),
    ...
    new Item('Heart Shaped Panties', Slot.ACCESSORY, SetName.NERD4, 100, [
        ...
        [Stat.RES3_POWER, 13.333332],
        [Stat.NGU_SPEED, 666.6666],
        [Stat.ENERGY_CAP, 1333.3332],
        [Stat.MAGIC_CAP, 1333.3332],
    ]),
    ...
    new Item('Infinity Charm', Slot.ACCESSORY, SetName.META, 100, [
        ...
        [Stat.SEED_DROP, 80],
        [Stat.ENERGY_CAP, 1777.7776],
        [Stat.MAGIC_CAP, 1777.7776],
    ]),
    ...
    new Item('Tear Away Pants', Slot.PANTS, SetName.PARTY, 100, [
        [Stat.POWER, 500000],
        [Stat.TOUGHNESS, 9000000],
        [Stat.MAGIC_BARS, 24000],
        [Stat.MAGIC_CAP, 2400],
        [Stat.ENERGY_POWER, 24000],
        [Stat.MAGIC_POWER, 24000],
    ]),
    ...
    new Item('The Godmother\'s Ring', Slot.ACCESSORY, SetName.MOBSTER3, 100, [
        ...
        [Stat.GOLD_DROP, 60000],
        [Stat.DROP_CHANCE, 1400],
        [Stat.RES3_CAP, 11],
    ]),
    ...
    new Item('Left Fairy Wing', Slot.ACCESSORY, SetName.MOBSTER4, 100, [
        ...
        [Stat.RES3_CAP, 16],
        [Stat.RES3_POWER, 160],
        [Stat.ENERGY_CAP, 16000],
    ]),
    new Item('Right Fairy Wing', Slot.ACCESSORY, SetName.MOBSTER4, 100, [
        [Stat.MAGIC_CAP, 18000],
        [Stat.ENERGY_BARS, 180000],
        [Stat.MAGIC_BARS, 180000],
    ...
    new Item('Buster of the Exile', Slot.ACCESSORY, SetName.EXILE4, 100, [
        ...
        [Stat.RES3_POWER, 800],
        [Stat.HACK_SPEED, 40],
        [Stat.ENERGY_POWER, 800000],
        [Stat.MAGIC_POWER, 800000],
    ]),
    ...
    new Item('Cool Shades', Slot.HEAD, SetName.RADLANDS, 100, [
        [Stat.POWER, 6600000],
        [Stat.TOUGHNESS, 174000000],
        [Stat.RES3_CAP, 29.4],
        [Stat.ENERGY_CAP, 29000],
        [Stat.MAGIC_CAP, 29000],
        [Stat.ENERGY_POWER, 288000],
        [Stat.MAGIC_POWER, 288000],
    ]),
    new Item('Leather Jacket', Slot.CHEST, SetName.RADLANDS, 100, [
        [Stat.POWER, 6800000],
        [Stat.TOUGHNESS, 172000000],
        [Stat.RES3_BARS, 294],
        [Stat.RES3_POWER, 296],
        [Stat.ENERGY_CAP, 29000],
        [Stat.MAGIC_CAP, 29000],
    ...
    new Item('Flamin\' Hot Shorts', Slot.PANTS, SetName.RADLANDS, 100, [
        ...
        [Stat.ENERGY_POWER, 288000],
        [Stat.MAGIC_POWER, 288000],
        [Stat.ENERGY_BARS, 290000],
        [Stat.MAGIC_BARS, 290000],
    ]),
    ...
    new Item('Nunchuks', Slot.WEAPON, SetName.RADLANDS, 100, [
        [Stat.POWER, 1760000000],
        [Stat.TOUGHNESS, 70000000],
        [Stat.ENERGY_POWER, 294000],
        [Stat.MAGIC_POWER, 294000],
        [Stat.ENERGY_CAP, 29400],
        [Stat.MAGIC_CAP, 29400],
        [Stat.ENERGY_BARS, 294000],
        [Stat.MAGIC_BARS, 294000],
    ]),
    new Item('Not Drugs', Slot.ACCESSORY, SetName.RADLANDS, 100, [
        [Stat.POWER, 180000000],
        [Stat.TOUGHNESS, 180000000],
        [Stat.HACK_SPEED, 29.4],
        [Stat.GOLD_DROP, 296000],
        [Stat.ENERGY_CAP, 29200],
        [Stat.MAGIC_CAP, 29200],
    ]),
    new Item('The Glove of Power', Slot.ACCESSORY, SetName.RADLANDS, 100, [
        [Stat.POWER, 260000000],
        [Stat.TOUGHNESS, 160000000],
        [Stat.RES3_POWER, 300],
        [Stat.AUGMENT_SPEED, 1100],
        [Stat.ENERGY_POWER, 300000],
        [Stat.MAGIC_POWER, 300000],
    ]),
    new Item('Dunce Cap', Slot.HEAD, SetName.BACKTOSCHOOL, 100, [
        [Stat.POWER, 9200000],
        [Stat.TOUGHNESS, 244000000],
        [Stat.RES3_POWER, 348],
        [Stat.ENERGY_BARS, 350000],
        [Stat.MAGIC_BARS, 350000],
        [Stat.ENERGY_POWER, 352000],
        [Stat.MAGIC_POWER, 352000],
    ]),
    new Item('School Jersey', Slot.CHEST, SetName.BACKTOSCHOOL, 100, [
        [Stat.POWER, 9200000],
        [Stat.TOUGHNESS, 244000000],
        [Stat.RES3_CAP, 34.8],
        [Stat.ENERGY_CAP, 34600],
        [Stat.MAGIC_CAP, 34600],
        [Stat.ENERGY_BARS, 356000],
        [Stat.MAGIC_BARS, 356000],
    ]),
    new Item('ULTRAWIDE Pants', Slot.PANTS, SetName.BACKTOSCHOOL, 100, [
        [Stat.POWER, 9200000],
        [Stat.TOUGHNESS, 244000000],
        [Stat.RES3_CAP, 34.8],
        [Stat.ENERGY_POWER, 346000],
        [Stat.MAGIC_POWER, 346000],
        [Stat.ENERGY_CAP, 35200],
        [Stat.MAGIC_CAP, 35200],
    ]),
    new Item('Shoes With Wheels', Slot.BOOTS, SetName.BACKTOSCHOOL, 100, [
        ...
        [Stat.RES3_BARS, 344],
        [Stat.RES3_POWER, 356],
        [Stat.ENERGY_POWER, 350000],
        [Stat.MAGIC_POWER, 350000],
    ]),
    new Item('Floppy Elastic Ruler', Slot.WEAPON, SetName.BACKTOSCHOOL, 100, [
        [Stat.POWER, 2280000000],
    ...
    new Item('THE S', Slot.ACCESSORY, SetName.BACKTOSCHOOL, 100, [
        [Stat.POWER, 360000000],
        [Stat.TOUGHNESS, 360000000],
        [Stat.RES3_POWER, 360],
        [Stat.WISH_SPEED, 36],
        [Stat.ENERGY_POWER, 360000],
        [Stat.MAGIC_POWER, 360000],
    ]),
    new Item('A Walkman', Slot.ACCESSORY, SetName.BACKTOSCHOOL, 100, [
        [Stat.POWER, 252000000],
        [Stat.TOUGHNESS, 180000000],
        [Stat.GOLD_DROP, 350000],
        [Stat.HACK_SPEED, 35],
        [Stat.WISH_SPEED, 35],
    ]),
    new Item('A 10 Litre Hat', Slot.HEAD, SetName.WESTWORLD, 100, [
        [Stat.POWER, 12000000],
        [Stat.TOUGHNESS, 318000000],
        [Stat.RES3_POWER, 418],
        [Stat.ENERGY_CAP, 42200],
        [Stat.MAGIC_CAP, 42200],
        [Stat.ENERGY_POWER, 426000],
        [Stat.MAGIC_POWER, 426000],
    ]),
    new Item('Asslest Vest', Slot.CHEST, SetName.WESTWORLD, 100, [
        ...
        [Stat.RES3_CAP, 42],
        [Stat.RES3_POWER, 424],
        [Stat.ENERGY_BARS, 414000],
        [Stat.MAGIC_BARS, 414000],
    ]),
    new Item('Assful Chaps', Slot.PANTS, SetName.WESTWORLD, 100, [
        [Stat.POWER, 12000000],
        [Stat.TOUGHNESS, 316000000],
        [Stat.RES3_POWER, 422],
        [Stat.RES3_BARS, 418],
        [Stat.ENERGY_CAP, 42400],
        [Stat.MAGIC_CAP, 42400],
    ]),
    new Item('Extra Spiky Spurs', Slot.BOOTS, SetName.WESTWORLD, 100, [
        [Stat.POWER, 12000000],
        [Stat.TOUGHNESS, 324000000],
        [Stat.RES3_CAP, 42.4],
        [Stat.ENERGY_POWER, 426000],
        [Stat.MAGIC_POWER, 426000],
        [Stat.ENERGY_BARS, 420000],
        [Stat.MAGIC_BARS, 420000],
    ]),
    new Item('The Six Shooter', Slot.WEAPON, SetName.WESTWORLD, 100, [
        [Stat.POWER, 2960000000],
        [Stat.TOUGHNESS, 116000000],
        [Stat.RES3_POWER, 416],
        [Stat.RES3_BARS, 422],
        [Stat.ENERGY_CAP, 42800],
        [Stat.MAGIC_CAP, 42800],
    ]),
    new Item('A Battle Corgi', Slot.ACCESSORY, SetName.WESTWORLD, 100, [
        [Stat.POWER, 440000000],
        [Stat.TOUGHNESS, 440000000],
        [Stat.WISH_SPEED, 42],
        [Stat.NGU_SPEED, 400],
    ]),
    new Item('A Pink Bandana', Slot.ACCESSORY, SetName.WESTWORLD, 100, [
        [Stat.POWER, 340000000],
        [Stat.TOUGHNESS, 340000000],
        [Stat.MAGIC_CAP, 72000],
        [Stat.ENERGY_POWER, 720000],
        [Stat.RES3_CAP, 62],
    ]),
    new Item('A 9mm Beretta', Slot.WEAPON, SetName.WESTWORLD, 100, [
        [Stat.POWER, 2800000000],
        [Stat.TOUGHNESS, 140000000],
        [Stat.RES3_CAP, 42],
        [Stat.NGU_SPEED, 500],
        [Stat.AUGMENT_SPEED, 1500],
    ]),
    new Item('Space Helmet', Slot.HEAD, SetName.ITHUNGERS, 100, [
        ...
        [Stat.RES3_POWER, 502],
        [Stat.RES3_CAP, 50.4],
        [Stat.ENERGY_CAP, 50600],
        [Stat.MAGIC_CAP, 50600],
    ]),
    ...
    new Item('Space Suit Legs', Slot.PANTS, SetName.ITHUNGERS, 100, [
        ...
        [Stat.TOUGHNESS, 410000000],
        [Stat.RES3_POWER, 498],
        [Stat.ENERGY_POWER, 512000],
        [Stat.MAGIC_POWER, 512000],
        [Stat.ENERGY_BARS, 506000],
        [Stat.MAGIC_BARS, 506000],
    ]),
    new Item('Space Boots', Slot.BOOTS, SetName.ITHUNGERS, 100, [
        ...
        [Stat.RES3_POWER, 508],
        [Stat.RES3_CAP, 51],
        [Stat.ENERGY_CAP, 50000],
        [Stat.MAGIC_CAP, 50000],
    ]),
    new Item('Space Gun!', Slot.WEAPON, SetName.ITHUNGERS, 100, [
        [Stat.POWER, 3840000000],
        [Stat.TOUGHNESS, 150000000],
        [Stat.RES3_POWER, 506],
        [Stat.RES3_CAP, 50],
        [Stat.ENERGY_POWER, 502000],
        [Stat.MAGIC_POWER, 502000],
    ]),
    new Item('A Manhole', Slot.ACCESSORY, SetName.ITHUNGERS, 100, [
        [Stat.POWER, 450000000],
        [Stat.TOUGHNESS, 450000000],
        [Stat.HACK_SPEED, 40.4],
        [Stat.MAGIC_POWER, 504000],
        [Stat.ENERGY_BARS, 504000],
        [Stat.MAGIC_BARS, 504000],
    ]),
    new Item('A Red Shirt', Slot.ACCESSORY, SetName.ITHUNGERS, 100, [
        [Stat.POWER, 600000000],
        [Stat.TOUGHNESS, 2],
        [Stat.WISH_SPEED, 40.6],
        [Stat.RESPAWN, 6],
        [Stat.RES3_CAP, 50.4],
    ]),
    new Item('\'The Cricket\'', Slot.WEAPON, SetName.ITHUNGERS, 100, [
        [Stat.POWER, 4200000000],
        [Stat.TOUGHNESS, 180000000],
        [Stat.MAGIC_POWER, 478000],
        [Stat.RES3_POWER, 506],
        [Stat.ENERGY_CAP, 50600],
        [Stat.MAGIC_CAP, 50600],
    ]),
    new Item('Evil Rubber Ducky', Slot.ACCESSORY, SetName.ITHUNGERS2, 100, [
        [Stat.POWER, 450000000],
        [Stat.TOUGHNESS, 450000000],
        [Stat.MAGIC_POWER, 602000],
        [Stat.ENERGY_CAP, 60600],
        [Stat.MAGIC_CAP, 60600],
        [Stat.ENERGY_BARS, 608000],
        [Stat.MAGIC_BARS, 608000],
    ]),
    new Item('A Gas Giant', Slot.ACCESSORY, SetName.ITHUNGERS2, 100, [
        [Stat.POWER, 580000000],
        [Stat.TOUGHNESS, 580000000],
        [Stat.RES3_POWER, 604],
        [Stat.RES3_CAP, 60.8],
        [Stat.AUGMENT_SPEED, 1500],
    ]),
    ...
    new Item('A Funky Klein Bottle', Slot.ACCESSORY, SetName.ITHUNGERS3, 100, [
        [Stat.POWER, 760000000],
        [Stat.TOUGHNESS, 760000000],
        [Stat.RES3_POWER, 730],
        [Stat.ENERGY_POWER, 1020000],
        [Stat.MAGIC_POWER, 1020000],
    ]),
    new Item('Giant Alien Bug Nest', Slot.ACCESSORY, SetName.ITHUNGERS4, 100, [
        [Stat.POWER, 912000000],
        [Stat.TOUGHNESS, 912000000],
        [Stat.QUEST_DROP, 16],
        [Stat.RES3_CAP, 88],
        [Stat.ENERGY_POWER, 874000],
        [Stat.MAGIC_POWER, 874000],
    ]),
    new Item('The Key', Slot.ACCESSORY, SetName.ITHUNGERS4, 100, [
        ...
        [Stat.ENERGY_POWER, 874000],
        [Stat.MAGIC_POWER, 874000],
        [Stat.ENERGY_BARS, 874000],
        [Stat.MAGIC_BARS, 874000],
    ]),
    ...
    new Item('SUPREME INTELLIGENCE LOOTY', Slot.ACCESSORY, SetName.LOOTY, 100, [
        ...
        [Stat.DROP_CHANCE, 4000],
        [Stat.ENERGY_POWER, 1000000],
        [Stat.MAGIC_POWER, 1000000],
    ]),
];
